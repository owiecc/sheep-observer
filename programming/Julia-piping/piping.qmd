...
Function `#13` is indeed quite unlucky. We did not catch it in time and it went to the void. [A Pokémon function?]{.aside} Confusingly, we can name an anonymous function. 
...
Smaller problem means less things to keep in your head at a time. A big code requires you to scroll through to find important things. Ideally, try keeping related code on one monitor screen[^1]. 

[^1]: Rotating the monitor helps.
