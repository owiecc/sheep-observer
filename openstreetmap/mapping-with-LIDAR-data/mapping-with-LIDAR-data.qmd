...
image: "bunker-LIDAR-surface.jpg"
...
![](bunker-aerial.jpg){fig-alt="Aerial view of forrest." fig-align="center" width=80%}
...
::: {layout-ncol=2}
![](bunker-LIDAR-surface.jpg){fig-alt="LIDAR view of forrest with visible foliage."}

![](bunker-LIDAR-terrain.jpg){fig-alt="LIDAR view of terrain under forest. Foliage not visible."}
:::
...
![](paths-aerial.jpg){fig-alt="Aerial view of forrest." fig-align="center" width=80%}
...
:::{.column-body-outset}
![](paths-LIDAR-terrain.jpg){fig-alt="Aerial view of forrest." fig-align="center" width=100%}
:::
